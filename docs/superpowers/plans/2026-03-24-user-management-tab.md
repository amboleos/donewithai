...
### Step 1.1: Extend PublicUser interface and update getAllUsers
...
Then find `getAllUsers` function (around line 763) and update the SQL:
...
### Step 1.2: Add createUser function
...
### Step 1.3: Add updateUser function
...
### Step 1.4: Add deleteUser function
...
- [ ] **Step 1.5: Verify changes compile**

Run: `npx tsc --noEmit`
Expected: No errors

- [ ] **Step 1.6: Commit DB changes**
...
### Step 2.1: Add POST handler to existing users route
...
### Step 2.2: Create [id] route for PUT and DELETE
...
- [ ] **Step 2.3: Verify changes compile**

Run: `npx tsc --noEmit`
Expected: No errors

- [ ] **Step 2.4: Commit API changes**

```bash
git add src/app/api/admin/users/
git commit -m "feat(api): add POST/PUT/DELETE endpoints for user management
...
## Task 3: UserDialog Component

**Files:**
- Create: `src/components/admin/user-dialog.tsx`

### Step 3.1: Create UserDialog component
...
## Task 4: UsersTab Component

**Files:**
- Create: `src/components/admin/users-tab.tsx`

### Step 4.1: Create UsersTab component
...
## Task 5: Update AdminTabs

**Files:**
- Modify: `src/components/admin/admin-tabs.tsx`

### Step 5.1: Add Users tab to AdminTabs

Update `src/components/admin/admin-tabs.tsx`:
...
- [ ] **Step 5.2: Verify changes compile**

Run: `npx tsc --noEmit`
Expected: No errors

- [ ] **Step 5.3: Commit AdminTabs update**
...
## Task 6: Test Agent for Automated Test Task List

### Step 6.1: Dispatch test agent

This task will dispatch a separate agent to create an automated test task list for the user management feature.

- [ ] **Dispatch test planning agent** - Create a separate agent to analyze the implemented feature and generate a comprehensive automated test task list covering:
  - Unit tests for DB functions (createUser, updateUser, deleteUser)
  - API endpoint tests (POST, PUT, DELETE)
  - Component tests (UserDialog, UsersTab)
